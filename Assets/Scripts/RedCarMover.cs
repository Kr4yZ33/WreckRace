...
public class RedCarMover : MonoBehaviour
{
    ...
    public float minDistanceToTarget = 0.000000000000000001f; // need to check this with Nathan but I think it's the distance where the Gaurd Capsule says its too close to the A or B transform position
    public float speed = 15f; // the speed the car moves at 
