...
public class AnimalSkinHitBehaviour : MonoBehaviour
{
    ...
    void ApplyHitColour()
    {
        ...
        {
            r.material.color = Color.grey; // apply the cyanw colour to the object
        }
        if (hit2 == true && hit3 == false) // if hit2 is true but hit 3 is not true yet
        {
            r.material.color = Color.grey; // apply the cyan colour to the object
        }
        if (hit3 == true && hit4 == false) // if hit3 is true but hit 4 is not true yet
        {
            r.material.color = Color.yellow; // apply the black colour to the object
        }
        ...
        {
            r.material.color = Color.red; // apply the magenta colour to the object
        }
