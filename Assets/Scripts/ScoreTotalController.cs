...
{
    public TimeScore timeScore; // reference to the Time Score script
    ...
    private void Start()
    {
        t = timeScore.timeScoreValue; // set the value of t to the value of the Time Score in the Time Score Script
