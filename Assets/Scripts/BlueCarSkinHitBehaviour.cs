...
public class BlueCarSkinHitBehaviour : MonoBehaviour
{
    ...
    void ApplyHitColour()
    {
        ...
        {
            r.material.color = Color.grey; // apply the yellow colour to the object
        }
    ...
    private void OnTriggerEnter(Collider other) // on a collision between this objects rigidbody and another objects rigidbody
    {
        ...
        {
            if (other.gameObject.layer != 16 && other.gameObject.layer != 17) // if the layer of the object colliding with us is not red ranged or melee
            {
